...
# Setup paths - go up 3 levels from tests/backend/e2e/ to root
...
def test_frontend_api_service():
    ...
    try:
        # Go up 3 levels from tests/backend/e2e/ to root, then to frontend
        frontend_api_path = Path(__file__).parent.parent.parent.parent / "frontend" / "src" / "services" / "api.js"
